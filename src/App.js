    ...
    return (
      <View>
        ...
        <View style={{display: "inline-block", marginBottom: 20, height: 28}}>
          <TextInput value={this.props.search} style={{minWidth: 250, height: 14.5}} onChange={this.onChange}/>
          <Text onClick={this.clearSearch} style={{cursor: "pointer", borderTop: "1px solid lightgray", borderBottom: "1px solid lightgray", borderRight: "1px solid lightgray", padding: 3, paddingLeft: 6, paddingRight: 6, userSelect: "none", cursor: "pointer"}}>X</Text>
        </View>
      </View>
    )
  }
