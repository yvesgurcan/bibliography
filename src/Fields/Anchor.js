  ...
  render = () => {
    ...
    return (
      <View style={{marginBottom: 10}}>
          <Label>Anchor:</Label>
          <TextInput name="anchor" onChange={this.saveChange} onBlur={this.props.saveRemotely} value={this.props.removeDangerousCharacters(this.props.lowerCase(reference.anchor || reference.name || reference.url))} style={{width: "100%", marginBottom: 0}}/>
